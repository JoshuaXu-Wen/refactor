...
resource sqlDatabse 'Microsoft.Sql/servers/databases@2021-08-01-preview' = {
  parent: sqlServer
...
resource storageAccount 'Microsoft.Storage/storageAccounts@2019-06-01' = {
  ...
  resource blobServices 'blobServices' existing = {
    name: 'default'
    resource containers 'containers@2021-08-01' = [for blobContainerName in blobContainerNames: {
